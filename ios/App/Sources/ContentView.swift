    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Terminal") {
                    LabeledContent("Identifier", value: abbreviated(model.terminalIdentifier.address.hex))
                    Text("This is a non-secret identifier used only to make invoice IDs unique. It is not a wallet or signing key.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                }
